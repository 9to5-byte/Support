...
INPUT_DIR = os.getenv("MARKDOWN_INPUT_DIR", "SUPPORT/docs/revenue/md")  # source markdown files directory
OUTPUT_DIR = os.getenv("INDEX_OUTPUT_DIR", "SUPPORT/index/revenue")     # output index directory
