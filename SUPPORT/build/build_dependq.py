...
INPUT_DIR = os.getenv("MARKDOWN_INPUT_DIR", "SUPPORT/docs/dependq/md")  # source markdown files directory
OUTPUT_DIR = os.getenv("INDEX_OUTPUT_DIR", "SUPPORT/index/dependq")     # output index directory
